...
function buildServerConfig({
  ...
  // Google Ads Enhanced Conversions is NOT included in the sGTM container.
  // aw_ct / awct are web-container-only tag types; sGTM has no native equivalent.
  // Google Ads conversion tracking is handled entirely by the web container
  // (client-side gtag / GA4 Config with send_to parameter).
